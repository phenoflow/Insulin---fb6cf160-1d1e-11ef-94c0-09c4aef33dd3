...
codes = [{"code":"32053","system":"gprdproduct"},{"code":"28978","system":"gprdproduct"},{"code":"31267","system":"gprdproduct"},{"code":"22058","system":"gprdproduct"},{"code":"26403","system":"gprdproduct"}];
REQUIRED_CODES = 1;
